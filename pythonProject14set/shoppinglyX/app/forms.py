...
class MyPasswordChangeForm(PasswordChangeForm):
    ...
    new_password2 = forms.CharField(label=("Comfirm New Password"), strip=False, widget=forms.PasswordInput(attrs={'autocomplete': 'new-password', 'autofocus': True, 'class': 'form-control'}))
...
class MySetPasswordForm(SetPasswordForm):
    ...
    new_password2 = forms.CharField(label=("Comfirm New Password"), strip=False, widget=forms.PasswordInput(
